...
class ConfluenceContentExtractor:
    ...
    def extract(self, raw_html: str, base_url: str = UWF_CONFLUENCE_BASE_URL, space_key: str = UWF_CONFLUENCE_PAGE_SPACE) -> str:
        """
        ...
        for link in soup.find_all('ac:link'):
            ...
            if page_ref and page_ref.has_attr('ri:content-title'):
                ...
                if link_body:
                    candidate_text = link_body.get_text(strip=True) # Trims whitespace and returns empty string if tag contains only whitespace
