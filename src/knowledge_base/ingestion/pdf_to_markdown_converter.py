...
class PDFToMarkdownConverter:
    ...
    def __init__(
        self,
        raw_data_path: Union[str, Path] = RAW_DATA_DIR,
        processed_data_path: Union[str, Path] = PROCESSED_DATA_DIR,
    ):
    ...
    def load_pdf_as_markdown(self, filename: str) -> List[Document]:
        ...
        try:
            loader = DoclingLoader(file_path=str(import_file_path), export_type=ExportType.MARKDOWN)
    ...
    # TODO: Remove redundant function and fix tests
