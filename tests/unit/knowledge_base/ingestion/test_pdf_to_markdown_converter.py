...
class TestPDFToMarkdownConverter:
    ...
    class TestLoadPDFAsMarkdown:
        ...
        def test_happy_path(
            ...
            mock_docling_loader.return_value.load.return_value = [Document(page_content=valid_md_file_content)]
            ...
            mock_docling_loader.assert_called_once_with(
                file_path=str(valid_pdf_filepath), export_type=ExportType.MARKDOWN
            )
    ...
    class TestSaveMarkdownFile:
        ...
        def test_save_markdown_file_success(
            self,
            pdf_converter,
            valid_processed_data_dir,
            valid_md_file_content,
            valid_md_filename,
        ):
        ...
        def test_save_markdown_file_creates_directory(
            self,
            pdf_converter,
            valid_data_dir,
            valid_md_file_content,
