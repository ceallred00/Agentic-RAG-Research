...
class AgentModelConfig(BaseModel):
    ...
    temperature: Annotated[float, Field(ge=0.0, le=2.0, description="The temperature setting for the model. 0.0 is deterministic, 1.0 is considered medium, higher values increase randomness.")]
...
class AgentConfig(BaseModel):
    ...
    model: Annotated[AgentModelConfig, Field(description="LLM technical configuration for the agent.")]
